...
'''
POR FAVOR NOTE QUE PARA ESTE CASO, EL ARCHIVO DEMAND.CSV DEBE CONTENER UNA COLUMNA LLAMADA "distancePriority" INDICANDO QUÉ COLEGIOS HAN SIDO 
INCLUIDOS DENTRO DE LAS POSTULACIONES BASADOS EN DISTANCIA.

Si el archivo demand.csv no contiene la columna "distancePriority", se detendrá la ejecución del algoritmo
'''
...
dir = '/Users/oscar/OneDrive/Escritorio/verificacion_DA/distancia_precalculad_VDISTANCE/'

##------------------------------------------------------------------------------------##

processed_dir = data_preparation(dir, type="precalculated_distance")
